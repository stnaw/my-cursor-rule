...
- No edits without permission: Do not modify existing code unless the user explicitly asks. If a change is needed, wait for approval or a reply of `1`. (Exception: when the user explicitly asks you to proceed autonomously.)
...
- 除非我主动要求，否则不得修改现有代码；如需修改，需我同意或回复"1"。(我主动让你自主推进的除外)
